...
(   
	...
	constraint PROFESSION_PK  primary key(PROFESSION),
    FACULTY char(10) not null,
	constraint PROFESSION_FACULTY_FK foreign key(FACULTY)
...
(  
	...
	constraint PULPIT_PK primary key(PULPIT),
    PULPIT_NAME varchar(100) null, 
    FACULTY char(10) not null,
	constraint PULPIT_FACULTY_FK foreign key(FACULTY) 
                         references FACULTY(FACULTY) 
);  
...
(   
	...
	constraint TEACHER_PK primary key(TEACHER),
    TEACHER_NAME varchar(100) null, 
    GENDER char(1) CHECK (GENDER in ('м', 'ж')),
    PULPIT char(20) not null,
	constraint TEACHER_PULPIT_FK foreign key(PULPIT) 
...
(
	...
	constraint SUBJECT_PK primary key(SUBJECT), 
    SUBJECT_NAME varchar(100) null unique,
    PULPIT char(20) not null,
	constraint SUBJECT_PULPIT_FK foreign key(PULPIT) 
                         references PULPIT(PULPIT) 
);
...
(
	...
	constraint AUDITORIUM_TYPE_PK  primary key(AUDITORIUM_TYPE),  
...
(
	...
	constraint AUDITORIUM_PK  primary key(AUDITORIUM),              
	AUDITORIUM_TYPE char(10) not null,
	constraint  AUDITORIUM_AUDITORIUM_TYPE_FK foreign key(AUDITORIUM_TYPE)         
...
(   
    ...
    FACULTY char(10) not null,
	constraint GROUPS_FACULTY_FK foreign key(FACULTY)         
                                                         references FACULTY(FACULTY), 
    PROFESSION char(20) not null,
	constraint GROUPS_PROFESSION_FK foreign key(PROFESSION)         
...
(   
	  ...
	  constraint STUDENT_GROUP_FK foreign key(IDGROUP)         
